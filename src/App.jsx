    ...
    <div className="container">
      <header className="flex-center" style={{ flexDirection: 'column', marginBottom: '1.5rem', textAlign: 'center' }}>
        ...
        >
          ...
          <h1 className="text-gradient" style={{ marginBottom: 0, fontSize: '2.25rem' }}>Carbon-Footprint-PromptWars</h1>
        </div>
      ...
      <footer style={{ marginTop: '4rem', textAlign: 'center', color: 'var(--text-secondary)', fontSize: '0.875rem' }}>
        <p>&copy; {new Date().getFullYear()} Carbon-Footprint-PromptWars. Building a sustainable future together.</p>
      </footer>
    </div>
  );
}
